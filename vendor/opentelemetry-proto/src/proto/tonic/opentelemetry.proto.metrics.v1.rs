...
pub mod number_data_point {
    ...
    pub enum Value {
        #[prost(double, tag = "4")]
        AsDouble(
            // PATCH (PulsusDB, docs/decisions/0004): special-double serde so a
            // non-finite gauge/sum sample round-trips as the protojson string.
            #[cfg_attr(
                feature = "with-serde",
                serde(
...
pub struct HistogramDataPoint {
    ...
    #[cfg_attr(
        feature = "with-serde",
        serde(
            serialize_with = "crate::proto::serializers::f64_special_opt::serialize",
    ...
    #[cfg_attr(
        feature = "with-serde",
        serde(
            serialize_with = "crate::proto::serializers::f64_special_vec::serialize",
            deserialize_with = "crate::proto::serializers::f64_special_vec::deserialize"
        )
    )]
...
pub struct Exemplar {
    ...
    // PATCH (PulsusDB, docs/decisions/0004): add `flatten` — upstream omits it
...
pub mod exemplar {
    ...
    pub enum Value {
        ...
        AsDouble(
            // PATCH (PulsusDB, docs/decisions/0004): special-double serde so a
            // non-finite exemplar value round-trips as the protojson string.
            #[cfg_attr(
                feature = "with-serde",
                serde(
                    serialize_with = "crate::proto::serializers::serialize_f64_special",
