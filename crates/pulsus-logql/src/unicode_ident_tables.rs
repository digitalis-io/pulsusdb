// @generated by `cargo test -p pulsus-logql --test identifier_charset -- --ignored regenerate_the_unicode_tables`
//
...
/// General category `L` — Go `unicode.IsLetter`, the reference's leading and continuing identifier rune.
/// 677 ranges, 141028 code points.
pub(crate) static LETTER: &[(char, char)] = &[
    ('\u{41}', '\u{5a}'),
    ('\u{61}', '\u{7a}'),
    ('\u{aa}', '\u{aa}'),
    ('\u{b5}', '\u{b5}'),
...
/// General category `Nd` — Go `unicode.IsDigit`, a continuing identifier rune only.
/// 71 ranges, 760 code points.
pub(crate) static DECIMAL_NUMBER: &[(char, char)] = &[
    ('\u{30}', '\u{39}'),
    ('\u{660}', '\u{669}'),
    ('\u{6f0}', '\u{6f9}'),
    ('\u{7c0}', '\u{7c9}'),
