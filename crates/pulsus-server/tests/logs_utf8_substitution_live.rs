...
//! and recorded in the ledger with the captured frames. **The ledger
//! entries themselves are prose and nothing checks them** — four
//! mechanisms were tried here and every one was defeated; the ledger's
//! own header says so and says why.
//!
//! ```text
