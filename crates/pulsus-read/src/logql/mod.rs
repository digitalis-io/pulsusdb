...
pub use exec::{
    ...
    LogStats, MatrixSeries, QueryResult, StreamResult, TailCursor, TailLower, TailPage, TailSetup,
    VectorSample, apply_vector_aggs, combine_binary, run_client_agg_rows,
};
