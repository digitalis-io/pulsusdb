...
const PREDICATE_ITEMS: &[&str] = &[
    ...
    "pub struct MetadataNameClasses<'a> :: pub selected: &'a [FpLiteral],",
    "pub struct MetadataNameClasses<'a> :: pub stream_label: &'a [FpLiteral],",
    "pub struct MetadataNameClasses<'a> :: pub stream_label_true: &'a [FpLiteral],",
    "pub struct MetadataNameClasses<'a> :: pub unsuffixed: &'a [FpLiteral],",
    "pub struct MetadataNameClasses<'a> :: pub direct: &'a [FpLiteral],",
    ...
    "#[cfg(test)]",
    "mod tests",
    "mod tests :: use pulsus_model::Fingerprint",
    "mod tests :: use super::*",
    ...
    "mod tests :: fn fps(n: usize) -> Vec<FpLiteral>",
    "mod tests :: fn classes<'a>(selected: &'a [FpLiteral], stream_label: &'a [FpLiteral], stream_label_true: &'a [FpLiteral], unsuffixed: &'a [FpLiteral], direct: &'a [FpLiteral], base_name: Option<&'a str>) -> MetadataNameClasses<'a>",
