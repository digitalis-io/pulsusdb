...
SELECT count() AS n FROM (
  ...
  FROM trace_spans
  WHERE timestamp_ns >= 1700000000000000000 AND timestamp_ns < 1700010800000000000 AND ((if(pi0s != 0, attr_val[pi0s] = '1', if(pi0r != 0, attr_val[pi0r] = '1', if(pi0e != 0, pm0e != 0, if(pi0l != 0, pm0l != 0, if(pi0i != 0, attr_val[pi0i] = '1', 0)))))))
  GROUP BY g0
  LIMIT 1001
)
