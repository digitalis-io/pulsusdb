-- case: issue492_select_span_attr
-- q: { resource.service.name = "checkout" } | select(span.http.method)
...
WITH arrayFirstIndex((k, s) -> k = 'http.method' AND s = 'span', attr_key, attr_scope) AS fs0
