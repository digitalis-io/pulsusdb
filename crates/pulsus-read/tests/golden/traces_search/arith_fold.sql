...
WITH arrayFirstIndex((k, s) -> k = 'a' AND s = 'span', attr_key, attr_scope) AS pi0s,
     ...
     arrayFirstIndex((k, s, n) -> k = 'a' AND s = 'event' AND n = 3, attr_key, attr_scope, attr_num) AS pm0e,
     arrayFirstIndex((k, s, n) -> k = 'a' AND s = 'link' AND n = 3, attr_key, attr_scope, attr_num) AS pm0l
