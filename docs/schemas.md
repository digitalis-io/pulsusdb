...
CREATE TABLE trace_attrs_idx (
    ...
    key           LowCardinality(String),
    val           String,
    scope         LowCardinality(String),        -- 'resource' | 'span' | 'instrumentation' | 'event' | 'event:intrinsic'
